...
(function(global, factory) {
  ...
  function report(_ref) {
    ...
    if (noConflictsCount > 0) {
      console.info(
        "%cNo conflict".concat(noConflictsCount > 1 ? "s" : "", " found with ").concat(
          noConflictsCount == 1 ? "this" : "these",
          ":",
        ),
  ...
  function detectWebfontConflicts() {
    ...
    function runDiag(scriptOrLinkTag, md5) {
      ...
      diagScript.innerText = "(".concat(diagScriptFun.toString(), ")('").concat(nodeUnderTestId, "', '").concat(
        testIconId || "foo",
        "', '",
      ).concat(md5, "', '").concat(parentOrigin, "');");
