  ...
  var ScrollSpy = /*#__PURE__*/ function() {
    ...
    _proto._activate = function _activate(target) {
      ...
      if ($link.hasClass(CLASS_NAME_DROPDOWN_ITEM)) {
        ...
        $link.parents(SELECTOR_NAV_LIST_GROUP).prev(SELECTOR_NAV_LINKS + ", " + SELECTOR_LIST_ITEMS).addClass(
          CLASS_NAME_ACTIVE,
        ); // Handle special case when .nav-link is inside .nav-item

        $link.parents(SELECTOR_NAV_LIST_GROUP).prev(SELECTOR_NAV_ITEMS).children(SELECTOR_NAV_LINKS).addClass(
          CLASS_NAME_ACTIVE,
        );
      }
