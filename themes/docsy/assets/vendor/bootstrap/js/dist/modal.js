  ...
  var Modal = /*#__PURE__*/ function() {
    ...
    _proto._showElement = function _showElement(relatedTarget) {
      ...
      if (transition) {
        ...
        $__default["default"](this._dialog).one(Util__default["default"].TRANSITION_END, transitionComplete)
          .emulateTransitionEnd(transitionDuration);
      } else {
        transitionComplete();
      }
    ...
    _proto._showBackdrop = function _showBackdrop(callback) {
      ...
      if (this._isShown && this._config.backdrop) {
        ...
        $__default["default"](this._backdrop).one(Util__default["default"].TRANSITION_END, callback)
        ...
        if ($__default["default"](this._element).hasClass(CLASS_NAME_FADE)) {
          ...
          $__default["default"](this._backdrop).one(Util__default["default"].TRANSITION_END, callbackRemove)
