  ...
  var Tooltip = /*#__PURE__*/ function() {
    ...
    _proto.show = function show() {
      ...
      if (this.isWithContent() && this._isEnabled) {
        ...
        if ($__default["default"](this.tip).hasClass(CLASS_NAME_FADE)) {
          ...
          $__default["default"](this.tip).one(Util__default["default"].TRANSITION_END, complete).emulateTransitionEnd(
            transitionDuration,
          );
        } else {
          complete();
    ...
    _proto.hide = function hide(callback) {
      ...
      if ($__default["default"](this.tip).hasClass(CLASS_NAME_FADE)) {
        ...
        $__default["default"](tip).one(Util__default["default"].TRANSITION_END, complete).emulateTransitionEnd(
          transitionDuration,
        );
      } else {
        complete();
