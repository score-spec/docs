$(function() {
  ...
  QUnit.test("should destroy tooltip", function(assert) {
    ...
    assert.strictEqual(
      typeof $._data($tooltip[0], "events").mouseover,
      "undefined",
      "tooltip does not have mouseover event",
    );
    assert.strictEqual(
      typeof $._data($tooltip[0], "events").mouseout,
      "undefined",
      "tooltip does not have mouseout event",
    );
  });
