$(function() {
  ...
  QUnit.test(
    ...
    function(assert) {
      ...
      var $el = $("<div class=\"modal fade\"><div class=\"modal-dialog\" style=\"transition-duration: 20ms;\"/></div>")
  ...
  QUnit.test("should not close modal when clicking outside of modal-content if backdrop = static", function(assert) {
    assert.expect(1);
    var done = assert.async();
    var $modal = $("<div class=\"modal\" data-backdrop=\"static\"><div class=\"modal-dialog\" /></div>").appendTo(
      "#qunit-fixture",
    );
  ...
  QUnit.test(
    "should close modal when escape key is pressed with keyboard = true and backdrop is static",
    function(assert) {
      assert.expect(1);
      var done = assert.async();
      var $modal = $(
        "<div class=\"modal\" data-backdrop=\"static\" data-keyboard=\"true\"><div class=\"modal-dialog\" /></div>",
      ).appendTo("#qunit-fixture");
  ...
  QUnit.test("should not overflow when clicking outside of modal-content if backdrop = static", function(assert) {
    ...
    var done = assert.async();
    var $modal = $(
      "<div class=\"modal\" data-backdrop=\"static\"><div class=\"modal-dialog\" style=\"transition-duration: 20ms;\"/></div>",
    ).appendTo("#qunit-fixture");
  ...
  QUnit.test(
    "should get modal-static class when clicking outside of modal-content if backdrop = static",
    function(assert) {
      assert.expect(1);
      var done = assert.async();
      var $modal = $(
  ...
  QUnit.test(
    "should not get modal-static class when clicking outside of modal-content if backdrop = static and event is prevented",
    function(assert) {
      assert.expect(2);
      var done = assert.async();
      var $modal = $(
