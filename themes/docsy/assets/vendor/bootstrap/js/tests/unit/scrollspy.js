    ...
    var testOffsetMethod = function(type) {
      var $navbar = $(
        "<nav class=\"navbar\"" + (type === "data" ? " id=\"navbar-offset-method-menu\"" : "") + ">"
          + "<ul class=\"nav\">"
          + "<li class=\"nav-item\"><a id=\"li-" + type + "m-1\" class=\"nav-link\" href=\"#div-" + type
          + "m-1\">div 1</a></li>"
          + "<li class=\"nav-item\"><a id=\"li-" + type + "m-2\" class=\"nav-link\" href=\"#div-" + type
          + "m-2\">div 2</a></li>"
          + "<li class=\"nav-item\"><a id=\"li-" + type + "m-3\" class=\"nav-link\" href=\"#div-" + type
          + "m-3\">div 3</a></li>"
          + "</ul>"
          + "</nav>",
      );
      var $content = $(
        "<div class=\"content\"" + (type === "data"
  ...
  QUnit.test("should allow passed in option offset method: position", function(assert) {
    ...
    var testOffsetMethod = function(type) {
      var $navbar = $(
        "<nav class=\"navbar\"" + (type === "data" ? " id=\"navbar-offset-method-menu\"" : "") + ">"
          + "<ul class=\"nav\">"
          + "<li class=\"nav-item\"><a class=\"nav-link\" id=\"li-" + type + "m-1\" href=\"#div-" + type
          + "m-1\">div 1</a></li>"
          + "<li class=\"nav-item\"><a class=\"nav-link\" id=\"li-" + type + "m-2\" href=\"#div-" + type
          + "m-2\">div 2</a></li>"
          + "<li class=\"nav-item\"><a class=\"nav-link\" id=\"li-" + type + "m-3\" href=\"#div-" + type
          + "m-3\">div 3</a></li>"
          + "</ul>"
          + "</nav>",
      );
