$(function() {
  ...
  QUnit.test("should destroy popover", function(assert) {
    ...
    assert.strictEqual(
      typeof $._data($popover[0], "events").mouseover,
      "undefined",
      "popover does not have mouseover event",
    );
    assert.strictEqual(
      typeof $._data($popover[0], "events").mouseout,
      "undefined",
      "popover does not have mouseout event",
    );
  });
