...
!function(e, t) {
  ...
  var p = function(n) {
    var e,
      ...
      Q = {
        ...
        PSEUDO: new RegExp("^" + W),
        CHILD: new RegExp(
          "^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + R + "*(even|odd|(([+-]|)(\\d*)n|)" + R
            + "*(?:([+-]|)" + R + "*(\\d+)|))" + R + "*\\)|)",
          "i",
        ),
        bool: new RegExp("^(?:" + I + ")$", "i"),
        ...
        C = se.setDocument = function(e) {
          ...
          return r != T && 9 === r.nodeType && r.documentElement
            && (a = (T = r).documentElement,
              E = !i(T),
              d != T && (n = T.defaultView) && n.top !== n && (n.addEventListener
              ...
              (p.matchesSelector = J.test(
                c = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector
                  || a.msMatchesSelector,
              )) && ce(function(e) {
          ...
          preFilter: {
            ...
            PSEUDO: function(e) {
              ...
              return Q.CHILD.test(e[0])
                ...
                : (e[3]
                  ? e[2] = e[4] || e[5] || ""
                  : n && V.test(n) && (t = h(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length)
                ...
                : function(e, t, n) {
                  ...
                  if (c) {
                    ...
                    if (u = [m ? c.firstChild : c.lastChild], m && d) {
                      p =
                        (s = (r = (i = (o = (a = c)[A] || (a[A] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0]
                      ...
                      while (a = ++s && a && a[l] || (p = s = 0) || u.pop()) {
                        if (
                          (b ? a.nodeName.toLowerCase() === f : 1 === a.nodeType) && ++p
    ...
    return me.prototype = x.filters = x.pseudos,
      ...
      h = se.tokenize = function(e, t) {
        ...
        while (a) {
          for (
            o in n && !(r = z.exec(a)) || (r && (a = a.slice(r[0].length) || a), s.push(i = [])),
              n = !1,
              (r = _.exec(a))
      ...
      g = se.select = function(e, t, n, r) {
        ...
        if (n = n || [], 1 === c.length) {
          if (
            2 < (o = c[0] = c[0].slice(0)).length && "ID" === (a = o[0]).type && 9 === t.nodeType && E
            && x.relative[o[1].type]
          ) {
  ...
  E.Callbacks = function(r) {
    ...
    E.extend({
      Deferred: function(e) {
        var o = [["notify", "progress", E.Callbacks("memory"), E.Callbacks("memory"), 2], [
            "resolve",
            "done",
    ...
    if (f && (t = (e = me(r, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
      ...
      if (s) {
        for (l = a[a.length - 1].ownerDocument, E.map(a, qe), c = 0; c < s; c++) {
          u = a[c],
            pe.test(u.type || "") && !Y.access(u, "globalEval") && E.contains(l, u)
  ...
  function et(e, t, n) {
    ...
    return (!m.boxSizingReliable() && i || !m.reliableTrDimensions() && S(e, "tr") || "auto" === a
      ...
      && e.getClientRects().length && (i = "border-box" === E.css(e, "boxSizing", !1, r), (o = s in e) && (a = e[s])),
    ...
    E.each(["height", "width"], function(e, u) {
      E.cssHooks[u] = {
        ...
        set: function(e, t, n) {
          ...
          return a && o
            && (s -= Math.ceil(
              e["offset" + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - Ze(e, u, "border", !1, i) - .5,
            )),
    ...
    E.cssHooks.marginLeft = Fe(m.reliableMarginLeft, function(e, t) {
      if (t) {
        return (parseFloat(We(e, "marginLeft"))
          || e.getBoundingClientRect().left - Be(e, { marginLeft: 0 }, function() {
  ...
  E.fn.extend({
    ...
    E.fn.extend({
      ...
      toggleClass: function(i, t) {
        ...
        return "boolean" == typeof t && a ? t ? this.addClass(i) : this.removeClass(i) : b(i)
    ...
    val: function(n) {
      ...
      return arguments.length
        ? (i = b(n),
          this.each(function(e) {
            var t;
            1 === this.nodeType && (null == (t = i ? n.call(this, e, E(this).val()) : n)
              ? t = ""
              : "number" == typeof t
              ? t += ""
              ...
              (r = E.valHooks[this.type] || E.valHooks[this.nodeName.toLowerCase()]) && "set" in r
                && void 0 !== r.set(this, t, "value") || (this.value = t));
          }))
        : t
        ? (r = E.valHooks[t.type] || E.valHooks[t.nodeName.toLowerCase()]) && "get" in r
    ...
    trigger: function(e, t, n, r) {
      ...
      if (
        o =
          ...
          n =
            n || w,
          3 !== n.nodeType && 8 !== n.nodeType && !lt.test(p + E.event.triggered)
        ...
        return e.type = p,
          r || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(d.pop(), t) || !X(n)
          || u && b(n[p]) && !x(n)
            && ((a = n[u]) && (n[u] = null),
              E.event.triggered = p,
    ...
    E.fn.extend({
      ...
      serializeArray: function() {
        return this.map(function() {
          ...
          var e = this.type;
          return this.name && !E(this).is(":disabled") && gt.test(this.nodeName) && !ht.test(e)
