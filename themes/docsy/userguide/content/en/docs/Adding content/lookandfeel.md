...
For pages containing a [blocks/cover][blocks/cover] shortcode, like most homepages, the
navbar is translucent as long as the hero image hasn't scrolled up past the
navbar. For an example, see the [About Docsy][About Docsy] page. This initial translucent
...
background color is set -- usually to the site's [primary color][primary color].
...
site's [configuration file][configuration file].
