...
## title: "Getting Started"linkTitle: "Getting Started"weight: 2date: 2018-07-30description: >This page tells you how to get started with the Docsy theme, including installation and basic configuration.
...
You can see how to get started with this approach by following our [DockerQuickstart tutorial](quickstart-docker). If you don't want to use Docker,
